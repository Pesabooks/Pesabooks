...
export class AccountsServices extends BaseApiService {
    ...
    getAll(onlySavings: boolean | undefined, includeDeactivated: boolean | undefined , cancelToken?: CancelToken | undefined): Promise<AccountsListDto[]> {
        let url_ = this.baseUrl + "/api/Accounts?";
        if (onlySavings === null)
            throw new Error("The parameter 'onlySavings' cannot be null.");
        else if (onlySavings !== undefined)
            url_ += "onlySavings=" + encodeURIComponent("" + onlySavings) + "&";
    ...
    protected processGetAll(response: AxiosResponse): Promise<AccountsListDto[]> {
        ...
        return Promise.resolve<AccountsListDto[]>(<any>null);
    }
    ...
    deactivate(command: DeactivateAccountCommand | null | undefined , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/Accounts/deactivate";
        url_ = url_.replace(/[?&]$/, "");
...
export class MembersServices extends BaseApiService {
    ...
    get(  cancelToken?: CancelToken | undefined): Promise<MemberListDto | null> {
    ...
    protected processGet(response: AxiosResponse): Promise<MemberListDto | null> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = resultData200 ? MemberListDto.fromJS(resultData200) : <any>null;
            return result200;
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
...
export class TransactionsServices extends BaseApiService {
    ...
    post(command: CreateTransactionCommand | null | undefined , cancelToken?: CancelToken | undefined): Promise<FileResponse | null> {
    ...
    get(memberId: number | null | undefined , cancelToken?: CancelToken | undefined): Promise<TransactionDto[] | null> {
        let url_ = this.baseUrl + "/api/Transactions?";
    ...
    protected processGet(response: AxiosResponse): Promise<TransactionDto[] | null> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class DeactivateAccountCommand implements IDeactivateAccountCommand {
    accountId!: number;

    constructor(data?: IDeactivateAccountCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DeactivateAccountCommand {
        data = typeof data === 'object' ? data : {};
        let result = new DeactivateAccountCommand();
        result.init(data);
        return result;
    }
...
export interface IDeactivateAccountCommand {
    accountId: number;
}
