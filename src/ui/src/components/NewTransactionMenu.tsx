...
import { BsArrowDownLeftCircleFill, BsArrowLeftRight, BsArrowUpRightCircleFill } from 'react-icons/bs';
  ...
  return walletConnected ? (
    <Menu>
      ...
      <MenuList>
        ...
        <MenuItem icon={<SwapLogo />} onClick={() => navigate(`/pool/${pool?.id}/swap`)}>
          Swap
        </MenuItem>
      </MenuList>
    </Menu>
